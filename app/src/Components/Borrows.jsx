...
const Borrows = () => {
    ...
    fetchBorrows();
    }, [getToken, navigate, fetchBorrows]);
    ...
    const updateBorrow = async (personId, bookId, borrowDate, returnDate) => {
        ...
        try {
            ...
            if (updateResponse && updateResponse.ok === 'SUCCESS') {
                ...
                throw new Error('Update sfailed');
            }
        } catch (error) {
    ...
    return (
        <div className="container mt-5">
            <h1 className="mb-5 text-center title_consolas">Borrow Registry</h1>
            <div className="card">
                <div className="card-body">
                    <table className="table table-striped">
                        ...
                        <tbody>
                            {borrows.map(borrow => (
                                <tr key={`${borrow.person_id}-${borrow.book_id}-${borrow.borrow_date}`}>
